// Package main es el entry point del servicio Scheduling.
package main
...
func main() {
	...
	cfg := mustLoadConfig()
	logger.Info("configuración cargada", "service", cfg.ServiceName, "port", cfg.Port)
	...
	go func() {
		logger.Info("servidor HTTP iniciado", "service", cfg.ServiceName, "addr", application.httpServer.Addr)
...
func mustLoadConfig() config {
	cfg := config{
		ServiceName: getEnv("SERVICE_NAME", "odontoagenda-scheduling"),
